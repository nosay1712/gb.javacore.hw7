...
public class UserInterface {
    ...
    public void runApplication() {
        ...
        while (true) {
            ...
            System.out.println("Please 1 for the current weather");
            System.out.println("Please 2 for for weather for the next 5 days");
            System.out.println("Please exit for end programm");
